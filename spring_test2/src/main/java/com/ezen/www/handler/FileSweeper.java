...
public class FileSweeper {
	...
	//매일 정해진 시간에 스케줄러를 실행
	//매일 등록된 파일과 (DB) <->해당일의 폴더에 있는 파일이 일치하는 파일은남기고 일치하지않는 파일은 삭제
	...
	public void fileSweeper() {
		...
		//listFiles 해당경로에 있는 모든 파일을 배열로 리턴 해줌
		File[] allFileObject=dir.listFiles();
		//실제 저장되어 잇는 파일과 db에 존재하는 파일을 비교하여 없는 파일은 삭제 진행

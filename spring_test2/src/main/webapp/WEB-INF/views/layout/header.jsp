    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
       ...
       <c:choose>
        	...
        	<c:otherwise>
	        <li class="nav-item">
	          <a class="nav-link" href="/user/modify<%-- ?email=${authEmail } --%>">회원정보수정 ${authNick }(${authEmail })</a>
	        </li>
        	</c:otherwise>    	
        </c:choose>
         <li class="nav-item">
	          <a class="nav-link" href="/user/remove">회원탈퇴</a>
	        </li>
	        <li class="nav-item">
	          <a class="nav-link" href="" id="logoutLink">로그아웃</a>
	        </li>
	        <form action="/user/logut" method="post" id="logoutForm">
	        	<!-- 인증된 계정의 이메일 -->
